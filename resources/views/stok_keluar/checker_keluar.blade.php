      ...
      <div class="col-12 mb-4 order-0">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="float-start">Checker Keluar</h5>
            </div>
              ...
              <div class="table-responsive text-nowrap">
                <table class="table" id="table">
                  ...
                  <tbody class="table-border-bottom-0">
                    ...
                    <td>{{ $index+1 }}</td>
                    <td>{{ $c->kd_gabungan }}</td>
                    <td>{{ $c->mitra->nm_mitra }}</td>
                      <td>{{ date("d/M/Y", strtotime($c->tgl)) }}</td>
                      <td>{{ date("H:i", strtotime($c->created_at)) }}</td>                      
                      <td><a class="btn btn-sm btn-primary" href="{{ route('detailKeluar',$c->kd_gabungan) }}"><i class='bx bx-task'></i></a></td>
                    </tr>
                    @endforeach
                  </tbody>
                </table>
