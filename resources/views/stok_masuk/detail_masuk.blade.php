    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            ...
            <div class="col-12 mb-4 order-0">
                ...
                <form action="{{ route('addChecker') }}" method="post">
                    @csrf
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        @foreach ($checker as $index => $c)
                                            <tr>
                                                ...
                                                <td>{{ $c->block->nm_block }}<br>{{ $c->cell->nm_cell }}<br>{{ $c->rak->nm_rak }}<br>
                                                    Pallet {{ $c->pallet_id }}</td>
                                                <td>{{ $c->debit_box }}
                                                    {{ Session::get('gudang_id') == 3 || Session::get('gudang_id') == 4 ? 'Karung' : 'Box' }}<br>{{ $c->debit_pak }}
                                                    Pak<br>{{ $c->debit_kg }} KG</td>
                                                <td>
