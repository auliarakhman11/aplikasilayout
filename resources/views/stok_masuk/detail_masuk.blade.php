        ...
        <form action="{{ route('addChecker') }}" method="post">
          ...
          <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('pdfDetailMasuk',$checker[0]->kd_gabungan) }}" target="_blank" class="btn btn-primary float-end mr-3 ml-3"><i class='bx bxs-file-pdf'></i> Print</a>
              ...
              <div class="table-responsive text-nowrap">
                <table class="table" width="100%">
                  ...
                  <tbody class="table-border-bottom-0">
                    ...
                    <td>{{ $c->debit_box }} {{ (Session::get('gudang_id') == 3 || Session::get('gudang_id') == 4) ? 'Karung' : 'Box' }}<br>{{ $c->debit_pak }} Pak<br>{{ $c->debit_kg }} KG</td>           
