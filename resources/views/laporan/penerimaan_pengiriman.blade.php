                        ...
                        <form action="" method="get">
                            <div class="row">
                                ...
                                <div class="col-6 col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="barang_id" class="form-control select2bs4" required>
                                            ...
                                            @foreach ($barang as $b)
                                                <option {{ $barang_id == $b->id ? 'selected' : '' }}
                                                    value="{{ $b->id }}">{{ $b->nm_barang }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-4 col-md-2">
                                    <a href="{{ route('pdfPenerimaanPengiriman', ['tgl' => $tgl, 'barang_id' => $barang_id]) }}"
                                        target="_blank" class="btn btn-sm btn-primary mt-4"><i class='bx bxs-file-pdf'></i>
                                        Print</a>
                                </div>
