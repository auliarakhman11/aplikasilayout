                ...
                <div class="card">
                    ...
                    <div class="card-body">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <select name="barang_id" class="form-control select2bs4" required>
                                            ...
                                            @foreach ($barang as $b)
                                                <option value="{{ $b->id }}|{{ $b->nm_barang }}">{{ $b->nm_barang }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="mt-2 col-6 col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="block_id" class="form-control" id="block" required>
                                            ...
                                            @foreach ($block as $b)
                                                <option value="{{ $b->id }}|{{ $b->nm_block }}">{{ $b->nm_block }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                      ...
                      <option value="">Pilih Pallet</option>
                                        ...
                                        <input type="number" name="pallet_id" class="form-control">
                                    </div>
                                </div>
            ...
            $(document).on('submit', '#form_input_return_barang', function(event) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#btn_add_cart').html(
                            '<i class="bx bxs-right-arrow-circle"></i> Lanjut'); //tombol
                        getCart();
            ...
            $(document).on('submit', '#form_save_return_barang', function(event) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#btn_input_data').html(
                        '<i class="bx bxs-save"></i> Input Stok'); //tombol
                        getCart();
