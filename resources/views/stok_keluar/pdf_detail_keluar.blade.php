...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="container">
            <table style="border: none !important;">
                <tbody>
                    <tr>
                        ...
                        <td style="border: none !important;">{{ $stok ? date('d-m-Y', strtotime($stok[0]->tgl)) : '' }}
                        </td>
                    </tr>
                    <tr>
            ...
            <center>
                <h5>FORM CHECKER BARANG KELUAR</h5>
            </center>
        </div>
                ...
                <tbody>
                    @foreach ($stok as $d)
                        <tr>
                            ...
                            <td style="text-align: center;">{{ $d->kredit_box }}
                                {{ Session::get('gudang_id') == 3 || Session::get('gudang_id') == 4 ? 'Karung' : 'Box' }}<br>{{ $d->kredit_pak }}
                                Pack<br>{{ $d->kredit_kg }} Kg</td>
                            <td style="text-align: center;">{{ $d->block->nm_block }} <br>{{ $d->cell->nm_cell }}
                                <br>{{ $d->rak->nm_rak }} <br>{{ $d->pallet->nm_pallet }}</td>
                            <td></td>
                        </tr>
                    @endforeach
                </tbody>
