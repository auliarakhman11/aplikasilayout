...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="container">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="border: none !important;">&nbsp; &nbsp;
                            {{ $stok ? date('d-m-Y', strtotime($stok[0]->tgl)) : '' }}</td>
                    </tr>
                    <tr>
                        <td style="border: none !important;" width="100px;">Jam</td>
                        <td style="border: none !important;">: </td>
                        <td style="border: none !important;">&nbsp; &nbsp;
                            {{ $stok ? date('H:i', strtotime($stok[0]->created_at)) : '' }}</td>
                    </tr>
                    <tr>
                        <td style="border: none !important;" width="100px;">Produksi</td>
                        <td style="border: none !important;">: </td>
                    ...
                    <tr>
                        ...
                        <td style="border: none !important;">: </td>
                        <td style="border: none !important;">&nbsp; &nbsp; {{ $stok ? $stok[0]->mitra->nm_mitra : '' }}
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <center>
                <h5>TALLY SHEET BARANG KELUAR</h5>
            </center>
        </div>
        ...
        <div class="container">
            <table class="table table-sm table-bordered" style="font-size: 12px;">
                <thead style="text-align: center;">
                    <tr>
                        ...
                        <th rowspan="2">Jumlah
                            ({{ Session::get('gudang_id') == 3 || Session::get('gudang_id') == 4 ? 'Karung' : 'Box' }})
                        </th>
                ...
                <tbody>
                    @foreach ($stok as $d)
                        <tr>
                            ...
                            <td style="text-align: center;">{{ $d->kredit_box }}</td>
                            <td style="text-align: center;">{{ $d->kredit_pak }}</td>
                            <td style="text-align: center;">{{ $d->kredit_kg }}</td>
            ...
            <table style="border: none !important; margin-top: 100px;" width="100%">
                <tbody>
                    <tr>
                        <td style="border: none !important; text-align: center; padding-bottom: 100px;">Admin Logistik
                        </td>
                        <td style="border: none !important; text-align: center; padding-bottom: 100px;">Foreman</td>
                        <td style="border: none !important; text-align: center; padding-bottom: 100px;">Leader</td>
                        <td style="border: none !important; text-align: center; padding-bottom: 100px;">Cheker</td>
                    </tr>
                    <tr>
