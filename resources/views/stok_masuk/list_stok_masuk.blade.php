            ...
            <form action="" method="get">
              <div class="row">
                ...
                <div class="col-12 col-md-5">
                  <h5 class="float-start">List Stok Masuk</h5>
                </div>
                      ...
                      @foreach ($stok as $index => $s)
                          <tr>
                            ...
                            <td>
                              ...
                              <a href="{{ route('deleteStokMasuk',$s->id) }}" class="btn btn-primary btn-sm" onclick="return confirm('Apakah anda yakin ingin menghapus data?');"><i class='bx bxs-trash'></i></a>
                            </td>
                          </tr>
                      @endforeach
                    </tbody>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="modal_edit_stokLabel">Edit Stok Masuk</h5>
